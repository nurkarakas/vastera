        ...
        <Button
          ...
          href={
            project.title === "Alius Card"
              ? "https://alius-card.vercel.app/"
              : project.title === "UnoLife"
              ? "https://uno-ruby-beta.vercel.app/"
              : project.title === "Brussels"
              ? "https://brussels-kappa.vercel.app/"
              : project.title === "Erol Bakır"
              ? "https://erol-bakir.vercel.app/"
              : project.title === "Hecotec"
              ? "https://hecotec.vercel.app/"
              : project.title === "Chef"
              ? "https://chef-tau-rosy.vercel.app/"
              : project.title === "KaliteliTakipçi"
              ? "https://kaliteli-takipci.vercel.app/"
              : project.title === "LocateMyWill"
              ? "https://locatemywill.vercel.app/"
              : project.title === "E-Commerce"
              ? "https://ecommerce-project-eta-pink.vercel.app/"
              :project.title === "Bright"
              ? "https://bright-kappa.vercel.app/"
              :project.title === "Hake Web"
              ? "https://hake-web.vercel.app/"
              :project.title === "Fineplast"
              ? "https://finplast.vercel.app/"
              : "#"
          }
          target="_blank"
        >
